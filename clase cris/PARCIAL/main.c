...
int main()
{
    ...
    cliente_altaForzada(arrayClientes,CANTIDAD_CLIENTES,"Pablo","Fargan","40-91191191-5");
    cliente_altaForzada(arrayClientes,CANTIDAD_CLIENTES,"Damian","Rodriguez","20-91191191-6");
    cliente_altaForzada(arrayClientes,CANTIDAD_CLIENTES,"Cristian","Saliba","30-91191191-6");
    cliente_altaForzada(arrayClientes,CANTIDAD_CLIENTES,"Batata","POTES","20-91191191-7");


    afiche_altaForzada(arrayAfiche,CANTIDAD_AFICHES,arrayClientes,CANTIDAD_CLIENTES,0,"RAMBO 1",10,1,1);
    afiche_altaForzada(arrayAfiche,CANTIDAD_AFICHES,arrayClientes,CANTIDAD_CLIENTES,1,"RAMBO 2",9,2,2);
    afiche_altaForzada(arrayAfiche,CANTIDAD_AFICHES,arrayClientes,CANTIDAD_CLIENTES,2,"RAMBO 3",8,3,1);
    ...
    while(opcionMenu >= 1 && opcionMenu < 11)
    {
        ...
        case 10:
             informar_mostrarVentaPorZona(arrayAfiche,CANTIDAD_AFICHES,1);
        }
