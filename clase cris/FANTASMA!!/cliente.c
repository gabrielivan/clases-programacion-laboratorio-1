...
//void cliente_mostrarLista(Cliente* array, int len,Afiche* arrayAfiche,lenAfiche)
//{
//      for(int i = 0; i < len; i++)
//    {
//        if(array[i].isEmpty == 0)
...
//            printf("El Apellido del Cliente es: %s\n",array[i].apellido);
//            printf("El Cuit del Cliente es: %s\n",array[i].cuit);
//            printf("Cantidad de ventas a cobrar: %d",CantidadVentas)
//            printf("\n\n");
//        }
//        limpiarMemoria();
//    }
//}
//int cliente_altaForzada(Cliente* array,int len,char* nombre,char* direccion, float precio, int tipo)
//{
//    int retorno = -1;
//    int i;
//
