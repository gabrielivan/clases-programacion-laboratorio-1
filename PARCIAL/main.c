...
int main()
{
    ...
    cliente_altaForzada(arrayClientes,CANTIDAD_CLIENTES,"cris","G","40-91191191-5");
    cliente_altaForzada(arrayClientes,CANTIDAD_CLIENTES,"gaby","F","20-91191191-6");
    cliente_altaForzada(arrayClientes,CANTIDAD_CLIENTES,"pablo","I","30-91191191-6");
    cliente_altaForzada(arrayClientes,CANTIDAD_CLIENTES,"damian","H","20-91191191-7");


    afiche_altaForzada(arrayAfiche,CANTIDAD_AFICHES,arrayClientes,CANTIDAD_CLIENTES,0,"RAMBO 1",20,1,1);
    afiche_altaForzada(arrayAfiche,CANTIDAD_AFICHES,arrayClientes,CANTIDAD_CLIENTES,1,"RAMBO 2",9,1,2);
