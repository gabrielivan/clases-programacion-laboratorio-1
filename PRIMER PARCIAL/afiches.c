...
*\param array Es el array que reciba para recorrer
*\param len Es el tamaño del array
*\param IdIngresado Es el ID que recibe para buscar
...
*\param array Es el array que reciba para recorrer
*\param arrayCliente Es el otro array a recorrer
*\param len es el tamaño del array
...
*\param arrayCliente Es el puntero que recibe del elemento del otro array
*\param len Es el tamaño del array
*\param lenCLiente es el tamaño del arrayCliente
...
/**
* \brief    Se utiliza esta funcion para cargar los datos de una
*           venta del array
*           el id se genera de manera automatica y se pone el isEmpty en 0
* \param    arrayCliente Es el array que se recorre
* \param    lenCliente Es el limite de clientes que puede guardar el array
...
*\param array Es el puntero que recibe del elemento del array
*\param len Es el tamaño del array
*\param idCliente es el id a comparar
*\return Retorna 0 si esta todo bien sino retorna -1
*/
...
/**
* \brief    Se utiliza esta funcion para mostrar todos los datos de los clientes del array con su cantidad de ventas
...
* \param    lenAfiche Es el limite del array de afiches
* \return   El retorno es 0 si se mostraron los datos, si no el retorno es -1.
*/
